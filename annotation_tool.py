    ...
    def annotate(category_annotated):
        ...
        if unannotated_indices:
            ...
            return (df_output.at[current_index, 'title'], df_output.at[current_index, 'context'],
                    ...
                    df_output.at[current_index, 'category'], 
                    f"Annotation saved. ({completed_annotations} of {total_annotations} completed)")
        else:
            return ("", "", "", "", "", "Annotation complete! All rows have been annotated.")
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            ...
            with gr.Column():
                ...
                category_radio = gr.Radio(["No Change", "person", "place", "quantity", "time", "general"], label="Correct Category?")
        ...
        # Listen for changes to category_radio to enable submit_button
